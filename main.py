...
button_list = [
    ...
    GamepadButton(10, board.GP14),  # bottom right toggle - DOWN
    GamepadButton(5, board.GP12),   # buttom right toggle - UP

    GamepadButton(6, board.GP17),   # bottom left toggle - UP
    GamepadButton(12, board.GP16),  # bottom left toggle - DOWN
